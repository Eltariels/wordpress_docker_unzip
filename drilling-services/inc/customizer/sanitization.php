 ...
 */
function drillingservices_sanitize_checkbox( $checked ) {
	// Boolean check.
...
function drillingservices_switch_sanitization( $input ) {
    if ( true === $input ) {
        return 1;
    } else {
        return 0;
...
function drillingservices_sanitize_choices( $input, $setting ) {
    global $wp_customize; 
...
function drillingservices_sanitize_float( $input ) {
 ...
 */
function drillingservices_sanitize_hex_color( $hex_color, $setting ) {
 ...
 */
function drillingservices_sanitize_html( $html ) {
 ...
 */
function drillingservices_sanitize_image( $image, $setting ) {
 ...
 */
function drillingservices_sanitize_nohtml( $nohtml ) {
 ...
 */
function drillingservices_sanitize_number_absint( $number, $setting ) {
 ...
 *                    the setting default.
 */
function drillingservices_sanitize_range_value( $number, $setting ) {
 ...
 */
function drillingservices_sanitize_select( $input, $setting ) {
 ...
 */
function drillingservices_sanitize_url( $url ) {
	return esc_url_raw( $url );
}


/* Sanitization Text*/
function drillingservices_sanitize_text( $text ) {
	return wp_filter_post_kses( $text );
}

/* Sanitization Integer*/
function drillingservices_sanitize_integer( $input ) {
    if( is_numeric( $input ) ) {
        return intval( $input );
    }
}
