( function( $ ) {
  var this_obj = drillingservices_customizer_params;
  ...
  api.bind( 'pane-contents-reflowed', function() {
    ...
    api.section.each( function( section ) {
      ...
      if (
        'drillingservices_section' !== section.params.type ||
    ...
    api.panel.each( function( panel ) {
      ...
      if (
        'drillingservices_panel' !== panel.params.type ||
  ...
  wp.customize.Panel = wp.customize.Panel.extend({
    attachEvents: function() {
      ...
      if (
        'drillingservices_panel' !== this.params.type ||
  ...
  wp.customize.Section = wp.customize.Section.extend({
    attachEvents: function() {
      if (
        'drillingservices_section' !== this.params.type ||
...
(function (api) {
  ...
  api.Tab = api.Control.extend({
    ready: function () {
      var control = this;
      control.container.find('a.drillingservices-customizer-tab').click(function (evt) {
        var tab = jQuery(this).data('tab');
        evt.preventDefault();
        control.container.find('a.drillingservices-customizer-tab').removeClass('active');
...
jQuery( document ).ready(function($) {
  ...
  $('.refresh-btn').on('click', function() {
    ...
    $.get( drillingservices_customizer_params.ajaxurl + '?action=' + dataValue, function( data ) {
